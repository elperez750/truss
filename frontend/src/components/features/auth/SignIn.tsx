...
export default function SignIn() {
    ...
    const { signInWithGoogle, signInWithEmail, isLoading, signInError, setSignInError, signInWithX } = useAuth();
    ...
    const handleSignInWithX = async () => {
        try {
            ...
            // TODO: Implement X OAuth when ready
        } catch (error) {
    ...
    return (
        <div className="space-y-6">
            ...
            <Button
                ...
                variant="outline"
                size="lg"
                className="w-full h-12 text-base font-medium border-gray-300 hover:bg-gray-50 cursor-pointer"
            >
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-transparent px-4 text-gray-500 font-medium">
                        Or continue with
                    </span>
                </div>
            </div>
